!(function (t, e) {
            ...
            _off: function (t, e, i) {
                ...
                if (this._events && (n = this._events[t]))
                    if (1 === arguments.length) {
                        if (this._firingCount) for (o = 0, s = n.length; o < s; o++) n[o].fn = _;
                        delete this._events[t];
                    } else
                        'function' != typeof e
                            ? console.warn('wrong listener type: ' + typeof e)
                            : !1 !== (e = this._listens(t, e, i)) && ((i = n[e]), this._firingCount && ((i.fn = _), (this._events[t] = n = n.slice())), n.splice(e, 1));
            },
            fire: function (t, e, i) {
                if (this.listens(t, i)) {
        ...
        (f.prototype = {
            extend: function (t) {
                ...
                if (t) {
                    ...
                    else if (((e = (t = c(t)).min), (i = t.max), !e || !i)) return this;
                    this.min || this.max
            ...
            contains: function (t) {
                var e, i;
                return (
                    (t = ('number' == typeof t[0] || t instanceof p ? m : c)(t)) instanceof f ? ((e = t.min), (i = t.max)) : (e = i = t),
    ...
    var ot = {
            ...
            infinite: !(v.prototype = {
                equals: function (t, e) {
                    return !!t && ((t = x(t)), Math.max(Math.abs(this.lat - t.lat), Math.abs(this.lng - t.lng)) <= (void 0 === e ? 1e-9 : e));
                },
                toString: function (t) {
    ...
    var _t = document.documentElement.style,
        ...
        Ct = (Gi = 'undefined' != typeof orientation || w('mobile')) && mt,
        Zt = Gi && Mt,
        ...
        Rt = (function () {
            ...
            try {
                ...
                window.addEventListener('testPassiveEventSupport', _, e), window.removeEventListener('testPassiveEventSupport', _, e);
            } catch (t) {}
            return t;
        })(),
    ...
    var b = {
        ...
        Wt = b.msPointer ? 'MSPointerMove' : 'pointermove',
        Ft = b.msPointer ? 'MSPointerUp' : 'pointerup',
        Ut = b.msPointer ? 'MSPointerCancel' : 'pointercancel',
        Vt = { touchstart: Ht, touchmove: Wt, touchend: Ft, touchcancel: Ut },
        qt = {
            touchstart: function (t, e) {
                e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && O(e), $t(t, e);
            },
            touchmove: $t,
            touchend: $t,
            touchcancel: $t
    ...
    var te,
        ...
        ne,
        oe,
        se = fe(['transform', 'webkitTransform', 'OTransform', 'MozTransform', 'msTransform']),
        re = fe(['webkitTransition', 'transition', 'OTransition', 'MozTransition', 'msTransition']),
    ...
    function M(t, e) {
        ...
        else _e(t, e) || pe(t, ((i = me(t)) ? i + ' ' : '') + e);
    }
    function z(t, e) {
        void 0 !== t.classList ? t.classList.remove(e) : pe(t, W((' ' + me(t) + ' ').replace(' ' + e + ' ', ' ')));
    }
    function pe(t, e) {
    ...
    function ge(t, e, i) {
        (e = e || new p(0, 0)), (t.style[se] = (b.ie3d ? 'translate(' + e.x + 'px,' + e.y + 'px)' : 'translate3d(' + e.x + 'px,' + e.y + 'px,0)') + (i ? ' scale(' + i + ')' : ''));
    }
    function Z(t, e) {
        (t._leaflet_pos = e), b.any3d ? ge(t, e) : ((t.style.left = e.x + 'px'), (t.style.top = e.y + 'px'));
    }
    function ve(t) {
    ...
    function we(t) {
        ...
        t.style && (be(), (oe = (ne = t).style.outlineStyle), (t.style.outlineStyle = 'none'), S(window, 'keydown', be));
    }
    function be() {
        ne && ((ne.style.outlineStyle = oe), (oe = ne = void 0), k(window, 'keydown', be));
    }
    function Pe(t) {
    ...
    function S(t, e, i, n) {
        ...
        else for (var s = 0, r = (e = F(e)).length; s < r; s++) Ze(t, e[s], i, n);
        return this;
    }
    var Te =
        ...
        E = '_leaflet_events';
    function k(t, e, i, n) {
        if (1 === arguments.length) ze(t), delete t[E];
    ...
    var Ce = { mouseenter: 'mouseover', mouseleave: 'mouseout', wheel: !('onwheel' in window) && 'mousewheel' };
    function Ze(e, t, i, n) {
        var o,
            s,
            r,
            ...
            !b.touchNative && b.pointer && 0 === t.indexOf('touch')
                ? (o = (function (t, e, i) {
                      return (
                          'touchstart' !== e ||
                              Kt ||
                              (document.addEventListener(Ht, Yt, !0), document.addEventListener(Wt, Xt, !0), document.addEventListener(Ft, Jt, !0), document.addEventListener(Ut, Jt, !0), (Kt = !0)),
                          qt[e] ? ((i = qt[e].bind(this, i)), t.addEventListener(Vt[e], i, !1), i) : (console.warn('wrong event specified:', e), _)
                      );
                  })(e, t, o))
                : b.touch && 'dblclick' === t
                ? ((a = o), (r = e).addEventListener('dblclick', a), (l = 0), r.addEventListener('click', c), (o = { dblclick: a, simDblclick: c }))
                : 'addEventListener' in e
                ? 'touchstart' === t || 'touchmove' === t || 'wheel' === t || 'mousewheel' === t
                    ? e.addEventListener(Ce[t] || t, o, !!b.passiveEvents && { passive: !1 })
        ...
        (o = o || e + d(i) + (n ? '_' + d(n) : '')),
            (i = t[E] && t[E][o]) &&
                (!b.touchNative && b.pointer && 0 === e.indexOf('touch')
                    ? ((n = t), (r = i), Vt[(s = e)] ? n.removeEventListener(Vt[s], r, !1) : console.warn('wrong event specified:', s))
                    : b.touch && 'dblclick' === e
                    ? ((r = t).removeEventListener('dblclick', (n = i).dblclick), r.removeEventListener('click', n.simDblclick))
                    : 'removeEventListener' in t
                    ? t.removeEventListener(Ce[e] || e, i, !1)
    ...
    function Ie(t, e) {
        var i, n;
        return e ? ((n = (i = Le(e)).boundingClientRect), new p((t.clientX - n.left) / i.x - e.clientLeft, (t.clientY - n.top) / i.y - e.clientTop)) : new p(t.clientX, t.clientY);
    }
        ...
        A = it.extend({
            ...
            initialize: function (t, e) {
                (e = h(this, e)),
                    ...
                    e.center && void 0 !== e.zoom && this.setView(x(e.center), e.zoom, { reset: !0 }),
                    this.callInitHooks(),
                    (this._zoomAnimated = re && b.any3d && !b.mobileOpera && this.options.zoomAnimation),
                    this._zoomAnimated && (this._createAnimProxy(), S(this._proxy, ae, this._catchTransitionEnd, this)),
                ...
                return (
                    ...
                    (t = m(t).round()).x || t.y
                        ? (!0 === e.animate || this.getSize().contains(t)
                              ? (this._panAnim || ((this._panAnim = new je()), this._panAnim.on({ step: this._onPanTransitionStep, end: this._onPanTransitionEnd }, this)),
            ...
            flyTo: function (o, s, t) {
                if (!1 === (t = t || {}).animate || !b.any3d) return this.setView(o, s, t);
                this._stop();
                var r = this.project(this.getCenter()),
                    a = this.project(o),
                    e = this.getSize(),
                    h = this._zoom,
                    l = ((o = x(o)), (s = void 0 === s ? h : s), Math.max(e.x, e.y)),
                    i = l * this.getZoomScale(h, s),
                    u = a.distanceTo(r) || 1,
                    c = 1.42,
                    d = c * c;
                function n(t) {
                    return (t = (i * i - l * l + (t ? -1 : 1) * d * d * u * u) / (2 * (t ? i : l) * d * u)), (t = Math.sqrt(t * t + 1) - t) < 1e-9 ? -18 : Math.log(t);
                }
                function _(t) {
                ...
                return (
                    ...
                    function t() {
                        var e,
                            i = (Date.now() - f) / v,
                            n = (1 - Math.pow(1 - i, 1.5)) * g;
                        i <= 1
                            ? ((this._flyToFrame = y(t, this)),
                              this._move(
                                  this.unproject(r.add(a.subtract(r).multiplyBy(((e = n), (l * (p(m) * (_((e = m + c * e)) / p(e)) - _(m))) / d / u))), h),
                                  this.getScaleZoom(l / ((i = n), l * (p(m) / p(m + c * i))), h),
                                  { flyTo: !0 }
                              ))
            ...
            project: function (t, e) {
                return (e = void 0 === e ? this._zoom : e), this.options.crs.latLngToPoint(x(t), e);
            },
            ...
            _initContainer: function (t) {
                if (!(t = this._container = he(t))) throw new Error('Map container not found.');
            ...
            _handleDOMEvent: function (t) {
                ...
                !this._loaded || i._leaflet_disable_events || ('click' === t.type && this._isClickDisabled(i)) || ('mousedown' === (e = t.type) && we(i), this._fireDOMEvent(t, e));
            },
            ...
            _limitCenter: function (t, e, i) {
                var n, o;
                return !i ||
                    ((n = this.project(t, e)), (o = this.getSize().divideBy(2)), (o = new f(n.subtract(o), n.add(o))), (o = this._getBoundsOffset(o, i, e)), Math.abs(o.x) <= 1 && Math.abs(o.y) <= 1)
                    ? t
            ...
            _getBoundsOffset: function (t, e, i) {
                return (
                    (i = (e = c(this.project(e.getNorthEast(), i), this.project(e.getSouthWest(), i))).min.subtract(t.min)),
    ...
    var B = et.extend({
        ...
        We =
            ...
            B.extend({
                ...
                initialize: function (t, e, i) {
                    for (var n in (h(this, i), (this._layerControlInputs = []), (this._layers = []), (this._lastZIndex = 0), (this._handlingClick = !1), (this._preventClick = !1), t))
                ...
                _initLayout: function () {
                    var t = 'leaflet-control-layers',
                        ...
                        n = (e.setAttribute('aria-haspopup', !0), Oe(e), ke(e), (this._section = P('section', t + '-list'))),
                        o =
                ...
                _addItem: function (t) {
                    ...
                    t.overlay
                        ...
                        : (e = this._createRadioElement('leaflet-base-layers_' + d(this), n)),
        ...
        Ve = B.extend({
            ...
            onAdd: function (t) {
                for (var e in (((t.attributionControl = this)._container = P('div', 'leaflet-control-attribution')), Oe(this._container), t._layers))
    ...
    var mt = { Events: e },
        ...
        Ge = it.extend({
            ...
            initialize: function (t, e, i, n) {
                h(this, n), (this._element = t), (this._dragStartTarget = e || t), (this._preventOutline = i);
            },
            enable: function () {
                this._enabled || (S(this._dragStartTarget, qe, this._onDown, this), (this._enabled = !0));
            },
            disable: function () {
                this._enabled && (Ge._dragging === this && this.finishDrag(!0), k(this._dragStartTarget, qe, this._onDown, this), (this._enabled = !1), (this._moved = !1));
            },
            _onDown: function (t) {
                var e, i;
                this._enabled &&
                    ...
                    _e(this._element, 'leaflet-zoom-anim') ||
                        (t.touches && 1 !== t.touches.length
                            ...
                            : Ge._dragging ||
                              ...
                              ((Ge._dragging = this)._preventOutline && we(this._element),
                              ye(),
                              ie(),
                              this._moving ||
                                  (this.fire('down'),
            ...
            finishDrag: function (t) {
                ...
                (this._moving = !1), (Ge._dragging = !1), e && this.fire('dragend', { noInertia: t, distance: this._newPos.distanceTo(this._startPos) });
            }
        });
    function Ke(t, e, i) {
        ...
        for (s = 0; s < 4; s++) {
            for (h = u[s], n = [], c = 0, o = (d = t.length) - 1; c < d; o = c++)
                (r = t[c]),
                    (a = t[o]),
                    r._code & h ? a._code & h || (((l = ei(a, r, h, e, i))._code = ii(l, e)), n.push(l)) : (a._code & h && (((l = ei(a, r, h, e, i))._code = ii(l, e)), n.push(l)), n.push(r));
            t = n;
        }
        return t;
    }
    function Ye(t, e) {
        ...
        for (
            var l = x([0, 0]), u = g(t), c = (u.getNorthWest().distanceTo(u.getSouthWest()) * u.getNorthEast().distanceTo(u.getNorthWest()) < 1700 && (l = Xe(t)), t.length), d = [], _ = 0;
            _ < c;
            _++
        ) {
            var p = x(t[_]);
            d.push(e.project(x([p.lat - l.lat, p.lng - l.lng])));
        }
        for (_ = r = a = h = 0, i = c - 1; _ < c; i = _++) (n = d[_]), (o = d[i]), (s = n.y * o.x - o.y * n.x), (a += (n.x + o.x) * s), (h += (n.y + o.y) * s), (r += 3 * s);
        return (u = 0 === r ? d[0] : [a / r, h / r]), x([(u = e.unproject(m(u))).lat + l.lat, u.lng + l.lng]);
    }
    function Xe(t) {
    ...
    var Je,
        ft = { __proto__: null, clipPolygon: Ke, polygonCenter: Ye, centroid: Xe };
    function $e(t, e) {
        if (e && t.length) {
            var i = (t = (function (t, e) {
                    for (var i, n, o, s = [t[0]], r = 1, a = 0, h = t.length; r < h; r++)
                        (i = t[r]), (n = t[a]), (o = void 0), (o = n.x - i.x) * o + (n = n.y - i.y) * n > e && (s.push(t[r]), (a = r));
            ...
            (o[0] = o[n - 1] = 1),
                (function t(e, i, n, o, s) {
                    for (var r, a, h = 0, l = o + 1; l <= s - 1; l++) h < (a = ni(e[l], e[o], e[s], !0)) && ((r = l), (h = a));
                    n < h && ((i[r] = 1), t(e, i, n, o, r), t(e, i, n, r, s));
                })(i, o, e, 0, n - 1);
    ...
    function si(t, e) {
        ...
        I(t) || (console.warn('latlngs are not flat! Only the first ring will be used'), (t = t[0]));
        for (
            var h = x([0, 0]), l = g(t), u = (l.getNorthWest().distanceTo(l.getSouthWest()) * l.getNorthEast().distanceTo(l.getNorthWest()) < 1700 && (h = Xe(t)), t.length), c = [], d = 0;
            d < u;
            d++
        ) {
            var _ = x(t[d]);
            c.push(e.project(x([_.lat - h.lat, _.lng - h.lng])));
        }
        ...
        return x([(l = e.unproject(m(a))).lat + h.lat, l.lng + h.lng]);
    }
    var gt = {
            __proto__: null,
            simplify: $e,
        ...
        xt = {
            ...
            Mercator: (yt = {
                ...
                unproject: function (t) {
                    for (
                        var e, i = 180 / Math.PI, n = this.R, o = this.R_MINOR / n, s = Math.sqrt(1 - o * o), r = Math.exp(-t.y / n), a = Math.PI / 2 - 2 * Math.atan(r), h = 0, l = 0.1;
        ...
        bt = l({}, st, { code: 'EPSG:3395', projection: yt, transformation: ht((wt = 0.5 / (Math.PI * yt.R)), 0.5, -wt, 0.5) }),
        ri = l({}, st, { code: 'EPSG:4326', projection: vt, transformation: ht(1 / 180, 1, -1 / 180, 0.5) }),
        Pt = l({}, ot, {
            projection: vt,
        ...
        ai =
            (A.include({
                ...
                removeLayer: function (t) {
                    ...
                    return (
                        this._layers[e] &&
                            (this._loaded && t.onRemove(this), delete this._layers[e], this._loaded && (this.fire('layerremove', { layer: t }), t.fire('remove')), (t._map = t._mapToAdd = null)),
                        this
                    );
                },
                hasLayer: function (t) {
            ...
            o.extend({
                initialize: function (t, e) {
                    var i, n;
                    if ((h(this, e), (this._layers = {}), t)) for (i = 0, n = t.length; i < n; i++) this.addLayer(t[i]);
                },
                addLayer: function (t) {
        ...
        hi = ai.extend({
            ...
            removeLayer: function (t) {
                return this.hasLayer(t)
                    ? ((t = t in this._layers ? this._layers[t] : t).removeEventParent(this), ai.prototype.removeLayer.call(this, t), this.fire('layerremove', { layer: t }))
                    : this;
            },
            setStyle: function (t) {
        ...
        ui = li.extend({
            ...
            _getIconUrl: function (t) {
                return 'string' != typeof ui.imagePath && (ui.imagePath = this._detectIconPath()), (this.options.imagePath || ui.imagePath) + li.prototype._getIconUrl.call(this, t);
            },
        ...
        ci = n.extend({
            ...
            _adjustPan: function (t) {
                var e = this._marker,
                    ...
                    r = i.getPixelBounds(),
                    a = i.getPixelOrigin();
                (a = c(r.min._subtract(a).add(o), r.max._subtract(a).subtract(o))).contains(s) ||
                    ((o = m(
        ...
        di = o.extend({
            ...
            _initIcon: function () {
                ...
                var o = !1;
                (i = t.icon.createShadow(this._shadow)) !== this._shadow && (this._removeShadow(), (o = !0)),
                    i && (M(i, e), (i.alt = '')),
                    (this._shadow = i),
            ...
            _initInteraction: function () {
                ...
                this.options.interactive &&
                    ...
                    ci && ((t = this.options.draggable), this.dragging && ((t = this.dragging.enabled()), this.dragging.disable()), (this.dragging = new ci(this)), t && this.dragging.enable()));
            },
        ...
        pi = _i.extend({
            ...
            initialize: function (t, e) {
                h(this, e), (this._latlng = x(t)), (this._radius = this.options.radius);
            },
            setLatLng: function (t) {
                var e = this._latlng;
            ...
            setStyle: function (t) {
                ...
                return _i.prototype.setStyle.call(this, t), this.setRadius(e), this;
            },
            _project: function () {
        ...
        mi = pi.extend({
            initialize: function (t, e, i) {
                if ((h(this, (e = 'number' == typeof e ? l({}, i, { radius: e }) : e)), (this._latlng = x(t)), isNaN(this.options.radius))) throw new Error('Circle radius cannot be NaN');
            ...
            _convertLatLngs: function (t) {
                for (var e = [], i = I(t), n = 0, o = t.length; n < o; n++) i ? ((e[n] = x(t[n])), this._bounds.extend(e[n])) : (e[n] = this._convertLatLngs(t[n]));
                return e;
            },
            _project: function () {
                var t = new f();
        ...
        gi =
            ((fi._flat = oi),
                ...
                _setLatLngs: function (t) {
                    fi.prototype._setLatLngs.call(this, t), I(this._latlngs) && (this._latlngs = [this._latlngs]);
                },
                _defaultShape: function () {
                ...
                _clipPoints: function () {
                    ...
                    if (((this._parts = []), this._pxBounds && this._pxBounds.intersects(t)))
                        if (this.options.noClip) this._parts = this._rings;
                        else for (var i, n = 0, o = this._rings.length; n < o; n++) (i = Ke(this._rings[n], t, !0)).length && this._parts.push(i);
                },
                _updatePath: function () {
        ...
        vi = hi.extend({
            ...
            addData: function (t) {
                ...
                return (r.filter && !r.filter(t)) || !(s = yi(t, r))
                    ? this
                    : ((s.feature = Mi(t)), (s.defaultOptions = s.options), this.resetStyle(s), r.onEachFeature && r.onEachFeature(t, s), this.addLayer(s));
            },
    ...
    function yi(t, e) {
        var i,
            ...
            h = [],
            l = e && e.pointToLayer,
            u = (e && e.coordsToLatLng) || wi;
        if (!a && !r) return null;
        switch (r.type) {
            case 'Point':
                return xi(l, t, (i = u(a)), e);
            case 'MultiPoint':
                for (o = 0, s = a.length; o < s; o++) (i = u(a[o])), h.push(xi(l, t, i, e));
                return new hi(h);
            case 'LineString':
            case 'MultiLineString':
                return (n = bi(a, 'LineString' === r.type ? 0 : 1, u)), new fi(n, e);
            case 'Polygon':
            case 'MultiPolygon':
                return (n = bi(a, 'Polygon' === r.type ? 1 : 2, u)), new gi(n, e);
    ...
    function bi(t, e, i) {
        for (var n, o = [], s = 0, r = t.length; s < r; s++) (n = e ? bi(t[s], e - 1, i) : (i || wi)(t[s])), o.push(n);
        return o;
    }
    function Pi(t, e) {
    ...
    function Li(t, e, i, n) {
        for (var o = [], s = 0, r = t.length; s < r; s++) o.push(e ? Li(t[s], I(t[s]) ? 0 : e - 1, i, n) : Pi(t[s], n));
        return !e && i && 0 < o.length && o.push(o[0].slice()), o;
    }
    function Ti(t, e) {
        return t.feature ? l({}, t.feature, { geometry: e }) : Mi(e);
    }
    function Mi(t) {
    ...
    di.include(
        (Lt = {
            toGeoJSON: function (t) {
                return Ti(this, { type: 'Point', coordinates: Pi(this.getLatLng(), t) });
            }
        })
    ),
        mi.include(Lt),
        pi.include(Lt),
            ...
            toGeoJSON: function (t) {
                ...
                return Ti(this, { type: (e ? 'Multi' : '') + 'LineString', coordinates: Li(this._latlngs, e ? 1 : 0, !1, t) });
            }
        }),
        gi.include({
            toGeoJSON: function (t) {
                var e = !I(this._latlngs),
                    ...
                    t = Li(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
                return Ti(this, { type: (i ? 'Multi' : '') + 'Polygon', coordinates: (t = e ? t : [t]) });
            }
        }),
        ai.include({
            toMultiPoint: function (e) {
                ...
                return (
                    ...
                    Ti(this, { type: 'MultiPoint', coordinates: i })
                );
            },
            toGeoJSON: function (e) {
                ...
                return 'MultiPoint' === t
                    ...
                    : ((i = 'GeometryCollection' === t),
                      (n = []),
                      this.eachLayer(function (t) {
                          t.toGeoJSON && ((t = t.toGeoJSON(e)), i ? n.push(t.geometry) : 'FeatureCollection' === (t = Mi(t)).type ? n.push.apply(n, t.features) : n.push(t));
                      }),
                      i ? Ti(this, { geometries: n, type: 'GeometryCollection' }) : { type: 'FeatureCollection', features: n });
            }
        });
    var Tt = zi,
        Ci = o.extend({
            ...
            initialize: function (t, e, i) {
                (this._url = t), (this._bounds = g(e)), h(this, i);
            },
            onAdd: function () {
        ...
        Si = Ci.extend({
            _initImage: function () {
                ...
                M(t, 'leaflet-image-layer'), this._zoomAnimated && M(t, 'leaflet-zoom-animated'), this.options.className && M(t, this.options.className), (t.onselectstart = _), (t.onmousemove = _);
            }
        }),
        Ei = o.extend({
            options: { interactive: !1, offset: [0, 0], className: '', pane: void 0, content: '' },
            initialize: function (t, e) {
                t && (t instanceof v || u(t)) ? ((this._latlng = x(t)), h(this, e)) : (h(this, t), (this._source = e)), this.options.content && (this._content = this.options.content);
            },
            openOn: function (t) {
        ...
        ki =
            ...
            o.include({
                _initOverlay: function (t, e, i, n) {
                    var o = i;
                    return o instanceof t ? (h(o, n), (o._source = this)) : (o = e && !n ? e : new t(n, this)).setContent(i), o;
                }
            }),
            Ei.extend({
                options: {
                ...
                onAdd: function (t) {
                    Ei.prototype.onAdd.call(this, t),
                        ...
                        this._source && (this._source.fire('popupopen', { popup: this }, !0), this._source instanceof _i || this._source.on('preclick', Ee));
                },
                onRemove: function (t) {
                    Ei.prototype.onRemove.call(this, t),
                        t.fire('popupclose', { popup: this }),
                        this._source && (this._source.fire('popupclose', { popup: this }, !0), this._source instanceof _i || this._source.off('preclick', Ee));
                },
                getEvents: function () {
                ...
                _updateLayout: function () {
                    ...
                    (n && n < i ? ((e.height = n + 'px'), M) : z)(t, 'leaflet-popup-scrolled'), (this._containerWidth = this._container.offsetWidth);
                },
                _animateZoom: function (t) {
        ...
        Oi =
            ...
            o.include({
                ...
                unbindPopup: function () {
                    return (
                        this._popup &&
                            (this.off({ click: this._openPopup, keypress: this._onKeyPress, remove: this.closePopup, move: this._movePopup }), (this._popupHandlersAdded = !1), (this._popup = null)),
                        this
                    );
                },
                openPopup: function (t) {
                    return this._popup && (this instanceof hi || (this._popup._source = this), this._popup._prepareOpen(t || this._latlng) && this._popup.openOn(this._map)), this;
                },
                closePopup: function () {
                ...
                _openPopup: function (t) {
                    ...
                    this._popup &&
                        ...
                        (Ae(t),
                        (e = t.layer || t.target),
                        this._popup._source !== e || e instanceof _i
            ...
            o.include({
                    ...
                    return (
                        this._tooltip &&
                            ...
                            this._tooltip._prepareOpen(t) &&
                                (this._tooltip.openOn(this._map), this.getElement ? this._setAriaDescribedByOnLayer(this) : this.eachLayer && this.eachLayer(this._setAriaDescribedByOnLayer, this))),
                        this
                    );
                },
                ...
                _moveTooltip: function (t) {
                    ...
                    this._tooltip.options.sticky &&
                        t.originalEvent &&
                        ((t = this._map.mouseEventToContainerPoint(t.originalEvent)), (t = this._map.containerPointToLayerPoint(t)), (e = this._map.layerPointToLatLng(t))),
            ...
            li.extend({
                ...
                createIcon: function (t) {
                    var t = t && 'DIV' === t.tagName ? t : document.createElement('div'),
                        e = this.options;
                    return (
                        e.html instanceof Element ? (ue(t), t.appendChild(e.html)) : (t.innerHTML = !1 !== e.html ? e.html : ''),
        ...
        Bi =
            ...
            o.extend({
                ...
                getEvents: function () {
                    ...
                    return (
                        this.options.updateWhenIdle || (this._onMove || (this._onMove = j(this._onMoveEnd, this.options.updateInterval, this)), (t.move = this._onMove)),
                ...
                _retainParent: function (t, e, i, n) {
                    var i = i - 1,
                        o = (((o = new p(+(t = Math.floor(t / 2)), +(e = Math.floor(e / 2)))).z = i), this._tileCoordsToKey(o));
                    ...
                    if ((n = this._map)) {
                        ...
                        if ((void 0 === t && (t = n.getCenter()), void 0 !== this._tileZoom)) {
                            var i,
                                ...
                                a = new f(o.getBottomLeft().subtract([n, -n]), o.getTopRight().add([n, -n]));
                ...
                _initTile: function (t) {
                    ...
                    (t.style.width = e.x + 'px'), (t.style.height = e.y + 'px'), (t.onselectstart = _), (t.onmousemove = _), b.ielt9 && this.options.opacity < 1 && C(t, this.options.opacity);
                },
                ...
                _tileReady: function (t, e, i) {
                    ...
                    (i = this._tiles[n]) &&
                        ((i.loaded = +new Date()),
                        this._map._fadeAnimated ? (C(i.el, 0), r(this._fadeFrame), (this._fadeFrame = y(this._updateOpacity, this))) : ((i.active = !0), this._pruneTiles()),
                        e || (M(i.el, 'leaflet-tile-loaded'), this.fire('tileload', { tile: i.el, coords: t })),
                        this._noTilesToLoad() &&
                            ((this._loading = !1), this.fire('load'), b.ielt9 || !this._map._fadeAnimated ? y(this._pruneTiles, this) : setTimeout(a(this._pruneTiles, this), 250)));
                },
        ...
        Ii = Bi.extend({
            ...
            initialize: function (t, e) {
                (this._url = t),
                    (e = h(this, e)).detectRetina && b.retina && 0 < e.maxZoom
            ...
            _abortLoading: function () {
                ...
                for (t in this._tiles)
                    this._tiles[t].coords.z !== this._tileZoom &&
                        (((i = this._tiles[t].el).onload = _),
                        (i.onerror = _),
                        i.complete || ((i.src = K), (e = this._tiles[t].coords), T(i), delete this._tiles[t], this.fire('tileabort', { tile: i, coords: e })));
            },
            _removeTile: function (t) {
                var e = this._tiles[t];
                if (e) return e.el.setAttribute('src', K), Bi.prototype._removeTile.call(this, t);
            },
            _tileReady: function (t, e, i) {
                if (this._map && (!i || i.getAttribute('src') !== K)) return Bi.prototype._tileReady.call(this, t, e, i);
            }
        });
    function Ri(t, e) {
        return new Ii(t, e);
    ...
    var Ni = Ii.extend({
            ...
            getTileUrl: function (t) {
                ...
                return (i = Ii.prototype.getTileUrl.call(this, t)) + U(this.wmsParams, i, this.options.uppercase) + (this.options.uppercase ? '&BBOX=' : '&bbox=') + e;
            },
        ...
        Di =
            ...
            o.extend({
                options: { padding: 0.1 },
                initialize: function (t) {
                    h(this, t), d(this), (this._layers = this._layers || {});
                },
                onAdd: function () {
        ...
        ji = Di.extend({
            ...
            _initPath: function (t) {
                this._updateDashArray(t),
                    (t = (this._layers[d(t)] = t)._order = { layer: t, prev: this._drawLast, next: null }),
            ...
            _bringToFront: function (t) {
                ...
                n &&
                    ((e = n.next),
                    (i = n.prev),
                    e && ((e.prev = i) ? (i.next = e) : e && (this._drawFirst = e), (n.prev = this._drawLast), ((this._drawLast.next = n).next = null), (this._drawLast = n), this._requestRedraw(t)));
            },
    ...
    var Wi = (function () {
        ...
        Mt = {
            ...
            _initPath: function (t) {
                ...
                M(e, 'leaflet-vml-shape ' + (this.options.className || '')), (e.coordsize = '1 1'), (t._path = Wi('path')), e.appendChild(t._path), this._updateStyle(t), (this._layers[d(t)] = t);
            },
            _addPath: function (t) {
                var e = t._container;
            ...
            _removePath: function (t) {
                var e = t._container;
                T(e), t.removeInteractiveTarget(e), delete this._layers[d(t)];
            },
            _updateStyle: function (t) {
                var e = t._stroke,
                    i = t._fill,
                ...
                (o.stroked = !!n.stroke),
                    ...
                    n.fill ? ((i = i || (t._fill = Wi('fill'))), o.appendChild(i), (i.color = n.fillColor || n.color), (i.opacity = n.fillOpacity)) : i && (o.removeChild(i), (t._fill = null));
            },
            _updateCircle: function (t) {
        ...
        Ui = Di.extend({
            ...
            _initPath: function (t) {
                ...
                t.options.className && M(e, t.options.className), t.options.interactive && M(e, 'leaflet-interactive'), this._updateStyle(t), (this._layers[d(t)] = t);
            },
            _addPath: function (t) {
                this._rootGroup || this._initContainer(), this._rootGroup.appendChild(t._path), t.addInteractiveTarget(t._path);
            },
            _removePath: function (t) {
                T(t._path), t.removeInteractiveTarget(t._path), delete this._layers[d(t)];
            },
            _updatePath: function (t) {
            ...
            _updateStyle: function (t) {
                ...
                e &&
                    ...
                    t.fill
                        ? (e.setAttribute('fill', t.fillColor || t.color), e.setAttribute('fill-opacity', t.fillOpacity), e.setAttribute('fill-rule', t.fillRule || 'evenodd'))
    ...
    function Vi(t) {
        return b.svg || b.vml ? new Ui(t) : null;
    }
    b.vml && Ui.include(Mt),
        A.include({
            ...
            _createRenderer: function (t) {
                return (this.options.preferCanvas && Hi(t)) || Vi(t);
            }
        });
    var qi = gi.extend({
            initialize: function (t, e) {
        ...
        _t =
            ...
            (vi.coordsToLatLng = wi),
            (vi.coordsToLatLngs = bi),
            (vi.latLngToCoords = Pi),
            (vi.latLngsToCoords = Li),
            (vi.getFeature = Ti),
            (vi.asFeature = Mi),
            ...
            n.extend({
                ...
                _onMouseDown: function (t) {
                    ...
                    this._clearDeferredResetState(),
                        ...
                        S(document, { contextmenu: Ae, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown }, this);
                },
                _onMouseMove: function (t) {
                ...
                _finish: function () {
                    this._moved && (T(this._box), z(this._container, 'leaflet-crosshair')),
                        Te(),
                        xe(),
                        k(document, { contextmenu: Ae, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown }, this);
                },
        ...
        Gi =
            (A.addInitHook('addHandler', 'doubleClickZoom', zt),
        ...
        Ct =
            (A.addInitHook('addHandler', 'dragging', Gi),
        ...
        Zt =
            ...
            n.extend({
                ...
                _onWheelScroll: function (t) {
                    ...
                    clearTimeout(this._timer), (this._timer = setTimeout(a(this._performZoom, this), e)), Ae(t);
                },
        ...
        St =
            ...
            n.extend({
                ...
                _simulateEvent: function (t, e) {
                    ((t = new MouseEvent(t, { bubbles: !0, cancelable: !0, view: window, screenX: e.screenX, screenY: e.screenY, clientX: e.clientX, clientY: e.clientY }))._simulated = !0),
        ...
        Ki =
            (A.addInitHook('addHandler', 'touchZoom', Et),
            (A.BoxZoom = _t),
